package fifo_pkg;
  ...
  class fifo_scoreboard extends uvm_component;
    ...
    task run_phase(uvm_phase phase);
      ...
      forever begin
        ...
        // Compare previous accepted read because DUT rdata is registered
  ...
  // Drain sequence used in Phase 2
  ...
  class fifo_base_test extends uvm_test;
    ...
    // Phase 2 helper: wait until FIFO becomes empty with timeout
  ...
  // =========================================================
  // Phase 2 upgraded random test with drain
  // =========================================================
  class fifo_random_test extends fifo_base_test;
    ...
    task run_phase(uvm_phase phase);
      ...
      // Let pipeline settle before drain decision
      wait_post_seq(10);

      // Snapshot expected outstanding depth from scoreboard model
      ...
      // Drain with enough reads to empty the FIFO
      ...
      // Wait until DUT reports empty
      wait_until_empty(300);

      // Let final registered read retire into scoreboard
      wait_post_seq(10);
